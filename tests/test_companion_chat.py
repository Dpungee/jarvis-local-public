...
class CompanionChatIntentTests(unittest.TestCase):
    def test_status_and_control_speech_acts_are_resolved(self):
        cases = {
            ...
            "turn Screen Companion off and confirm the change": CompanionChatIntent("off"),
            "pause Screen Companion, then report the new status": CompanionChatIntent("pause"),
            "resume Screen Companion and let me know that it is resumed": CompanionChatIntent("resume"),
